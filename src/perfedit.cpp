...
perfedit::perfedit( perform *a_perf )
{
    ...
    //TODO: make sure max_tick is updated when these are used:
    ...
    m_hlbox->pack_end( *m_button_undo , 	false, false );		/* DONE */
    ...
    m_hlbox->pack_start( *m_button_endstop , false, false );
...
perfedit::set_endstop( void )
{
    ...
    */
	...
	//TODO: verbose flag
	if(m_endstop){
		printf("Play will stop after last sequence\n");
	}
	else{
		printf("Play will continue forever\n");
	}
}
