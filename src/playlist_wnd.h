...
class playlist_wnd:public Gtk::Window
{
  ...
  private:
    ...
    //toggle whether playback stops at end of song
    ToggleButton *m_button_endstop;
    bool	 m_endstop; 		//Whether to stop at end or not
    ...
    Button *m_button_shrink;	//Decrease the number of bars in the grid
    Button *m_button_grow;		//Increase the number of bars in the grid
