...
/* piano time*/
/* This class is part of the song editor gui. It handles the region with the bar numbers on only, and thus the placement of the 'L' and 'R'
 * loop delimeters, which are placed with left and right mouse clicks respectively.
 * It must also handle repainting caused by horizontal scrolling
 *
 * TODO: Update when the play line passes out of view.
 */
