...
perfroll::perfroll( perform *a_perf,
    ...
    m_growing(false)
{
	//Assign the colors we are going to use
    ...
    //Add the set of events that we are going to use
...
perfroll::init_before_show( )
{
    ...
    m_roll_length_ticks = m_roll_length_ticks - ( m_roll_length_ticks % ( c_ppqn * 16 ));
...
perfroll::draw_progress()
{
    ...
    /* redraw the bit of the roll that was under the last tick */
